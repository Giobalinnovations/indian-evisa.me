    ...
    <div className="relative">
      ...
      >
        ...
        <div className="relative h-full text-white">
          <div className="container h-full p-4 md:p-0">
            <div className="flex flex-col items-center justify-center w-full h-full space-y-6 md:space-y-8 text-center">
              <div className="max-w-4xl">
                ...
                <p className="max-w-2xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed text-gray-200">
      ...
      <div className="absolute bottom-0 w-full bg-gradient-to-r from-black/95 via-black/85 to-black/95 backdrop-blur-sm border-t border-white/10">
